...
/**
 Here are the current constraints on the class for reference
 ...
 wage min: 0F, scale: 2F //It appears that scale doesn't cause validation fail, it just rounds number
 children maxSize: 10, minSize: 2
 fingers nullable: true
 homePage url: true
 username validator: {if(!it.startsWith('boba')) return ['invalid.bountyhunter']}*/
